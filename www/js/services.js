...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://cartsnb.firebaseio.com/"),
    refCart = new Firebase("https://cartsnb.firebaseio.com/cart"),
    refUser = new Firebase("https://cartsnb.firebaseio.com/users"),
    refCategory = new Firebase("https://cartsnb.firebaseio.com/category"),
    refOrder = new Firebase("https://cartsnb.firebaseio.com/orders"),
    refFeatured = new Firebase("https://cartsnb.firebaseio.com/featured"),
    refMenu = new Firebase("https://cartsnb.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
